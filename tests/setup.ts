...
// The voice vendor's two webhooks each carry their own credential, and both are
// read into config at import time, so they have to exist before the app loads.
process.env.ELEVENLABS_WEBHOOK_SECRET = 'fixture-elevenlabs-webhook-secret';
process.env.ELEVENLABS_INITIATION_SECRET = 'fixture-elevenlabs-initiation-secret';
